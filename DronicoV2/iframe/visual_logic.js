 ...
 * Tue Mar 30 2021 12:00:07 GMT+0300 (Москва, стандартное время)
...
_initGlob.output.initOptions.preloaderStartCb = function() {
    _initGlob.percentage = 0;
    (function() {
  createCSSRule('.v3d-simple-preloader-bar', ('    background: #000;' + '\n' +
  '	border-color: #000;' + '\n' +
  '	margin-top: 50%;'), false);
  createCSSRule('.v3d-simple-preloader-logo', 'display:none;', false);
  createCSSRule('.v3d-simple-preloader-logo', 'background: #fff0;', false);
})();
};
...
var Sphere_anim, Box_anim, torus_anim, speed_rotation, sped_animation;
...
operateAnimation('PLAY', 'Area', null, null, 'LoopRepeat', 0.2,
        function() {}, undefined, false);

    Sphere_anim = ['Box001', 'Torus001'];
Box_anim = ['GeoSphere001', 'Torus001'];
torus_anim = ['GeoSphere001', 'Box001'];
changeVis('Torus001', false);
changeVis('Box001', false);

operateAnimation('PLAY', 'Torus001', null, null, 'LoopOnce', 1,
        function() {}, undefined, false);


operateAnimation('PLAY', 'Box001', null, null, 'LoopOnce', 1,
        function() {}, undefined, false);

    speed_rotation = (0.5);
sped_animation = 0.38;
registerEveryFrame(function() {
  applyObjLocalTransform('GeoSphere001', 'rotation', speed_rotation, '', speed_rotation);
  applyObjLocalTransform('Box001', 'rotation', speed_rotation, '', speed_rotation);
  applyObjLocalTransform('Torus001', 'rotation', speed_rotation, speed_rotation, '');
});
eventHTMLElem('click', 'second', true, function(event) {

  operateAnimation('PLAY', Sphere_anim, null, null, 'LoopOnce', sped_animation,
          function() {
    changeVis('GeoSphere001', true);
    changeVis('Torus001', false);
    changeVis('Box001', false);

    operateAnimation('PLAY', 'GeoSphere001', null, null, 'LoopOnce', sped_animation,
            function() {}, undefined, true);

        }, undefined, false);

      });
eventHTMLElem('click', 'first', true, function(event) {

  operateAnimation('PLAY', Box_anim, null, null, 'LoopOnce', sped_animation,
          function() {
    changeVis('Box001', true);
    changeVis('Torus001', false);
    changeVis('GeoSphere001', false);

    operateAnimation('PLAY', 'Box001', null, null, 'LoopOnce', sped_animation,
            function() {}, undefined, true);

        }, undefined, false);

      });
eventHTMLElem('click', 'third', true, function(event) {

  operateAnimation('PLAY', torus_anim, null, null, 'LoopOnce', sped_animation,
          function() {
    changeVis('Torus001', true);
    changeVis('GeoSphere001', false);
    changeVis('Box001', false);

    operateAnimation('PLAY', 'Torus001', null, null, 'LoopOnce', sped_animation,
            function() {}, undefined, true);
