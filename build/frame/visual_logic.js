 ...
 * Thu Mar 25 2021 18:45:49 GMT+0300 (Москва, стандартное время)
...
operateAnimation('PLAY', 'Box001.001', null, null, 'LoopOnce', 1,
...
changeVis('Box001.001', false);
speed_rotation = (0.3);
bloom(0, 5, 0.1);
registerEveryFrame(function() {
  applyObjLocalTransform('GeoSphere001', 'rotation', speed_rotation, speed_rotation, speed_rotation);
  applyObjLocalTransform('Box001.001', 'rotation', speed_rotation, speed_rotation, speed_rotation);
  applyObjLocalTransform('Torus001', 'rotation', speed_rotation, speed_rotation, speed_rotation);
});
eventHTMLElem('click', 'first', false, function(event) {

  operateAnimation('PLAY', 'GeoSphere001', null, null, 'LoopOnce', 1,
          function() {
    changeVis('Box001.001', true);
    changeVis('Torus001', false);
    changeVis('GeoSphere001', false);
  }, undefined, false);


  operateAnimation('PLAY', 'Box001.001', null, null, 'LoopOnce', 2,
          function() {}, undefined, true);

      });
eventHTMLElem('click', 'second', false, function(event) {
  ...
  operateAnimation('PLAY', 'GeoSphere001', null, null, 'LoopOnce', 2,
          function() {}, undefined, true);

      });
eventHTMLElem('click', 'third', false, function(event) {
  ...
  operateAnimation('PLAY', 'Torus001', null, null, 'LoopOnce', 2,
          function() {}, undefined, true);
