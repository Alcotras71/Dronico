 ...
 * Fri Mar 26 2021 16:18:52 GMT+0300 (Москва, стандартное время)
...
var Sphere_anim, Box_anim, torus_anim, speed_rotation;
...
operateAnimation('PLAY', 'Area', null, null, 'LoopOnce', 0.2,
...
eventHTMLElem('click', 'second', true, function(event) {
  ...
  operateAnimation('PLAY', Sphere_anim, null, null, 'LoopOnce', 1,
          function() {
    changeVis('GeoSphere001', true);
    changeVis('Torus001', false);
    changeVis('Box001', false);

    operateAnimation('PLAY', 'GeoSphere001', null, null, 'LoopOnce', 1,
...
eventHTMLElem('click', 'first', true, function(event) {
  ...
  operateAnimation('PLAY', Box_anim, null, null, 'LoopOnce', 1,
          function() {
...
eventHTMLElem('click', 'third', true, function(event) {
  ...
  operateAnimation('PLAY', torus_anim, null, null, 'LoopOnce', 1,
          function() {
